...
public class Studentapp extends JFrame implements ActionListener { 
    ...
    JButton  b;
    String ts7,ts2,ts3,ts4,ts5,ts6,ts1;
    ResultSet rs;
     Studentapp()
     {
        setVisible(true);
        ...
        lab1 = new JLabel(" Student Details :");
        lab1.setForeground(Color.blue);
        lab1.setFont(new Font("Serif", Font.BOLD, 20));
        lab2 = new JLabel("STUDENT_ID:");
        lab3 = new JLabel("DATE OF BIRTH:");
        lab4 = new JLabel("GENDER:");
        lab5 = new JLabel("PERFORMANCE:");
        lab6 = new JLabel("RANK:");
        lab7 = new JLabel("STUDENT_NAME:"); 
        tf1 = new JTextField();
        tf2 = new JTextField();
        tf3 = new JTextField();
        tf4 = new JTextField();
       ...
       b.addActionListener(this);
        ...
        add(tf6);
         ...
         try{
             ...
             rs=stmt.executeQuery("select *from CHAKKU where STUDENTID=2");
