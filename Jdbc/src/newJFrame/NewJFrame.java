    ...
    private void DISPLAYActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DISPLAYActionPerformed
       ...
       try
       {
           Class.forName("com.mysql.jdbc.Driver");
            ...
            ResultSet rs=st.executeQuery("select *from det where Rollno='"+ss+"'");
            if(rs.next())
    {
    ...
    private void ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADDActionPerformed
        ...
        try{
             ...
             Statement stmt=con.createStatement();
              stmt.execute("insert into det values('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jTextField3.getText()+"','"+jTextField4.getText()+"','"+jTextField5.getText()+"','"+jTextField6.getText()+"')");            
            }
